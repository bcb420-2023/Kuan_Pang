...
- The final coverage of our dataset is described in the following table:
  ...
  | Final Coverage            |       `r nrow(corrected_pSS_exp_filtered)`      |    23    |
  | $\%$     |       40.0\%      |     79.3\%   |
